...
public class BlockStoneQuarterBlock extends Block {
    public BlockStoneQuarterBlock(){
        super(Material.rock);
        this.setBlockName("StoneQuarterBlock");
        this.setHardness(2F);
        this.setHarvestLevel("pickaxe",1);
        this.setResistance(10F);
        this.setStepSound(soundTypeStone);
        this.setCreativeTab(CreativeTabsLoader.tabStairsRevolution);
        this.setBlockTextureName(StairsRevolution.MODID + ":stone_quarterblock");
    }
}
