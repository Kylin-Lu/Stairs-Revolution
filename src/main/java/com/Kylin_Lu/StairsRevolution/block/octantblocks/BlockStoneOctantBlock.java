...
package com.Kylin_Lu.StairsRevolution.block.octantblocks;
...
public class BlockStoneOctantBlock extends Block{
    public BlockStoneOctantBlock(){
        super(Material.rock);
        this.setBlockName("StoneOctantBlock");
        this.setHardness(2F);
        this.setHarvestLevel("pickaxe",1);
        this.setResistance(10F);
        this.setStepSound(soundTypeStone);
        this.setCreativeTab(CreativeTabsLoader.tabStairsRevolution);
        this.setBlockTextureName(StairsRevolution.MODID + ":stone_octantblock");
    }
}
