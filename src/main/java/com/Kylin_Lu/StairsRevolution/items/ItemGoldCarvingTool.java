...
public class ItemGoldCarvingTool extends Item {
    public ItemGoldCarvingTool(){
        super();
        this.setUnlocalizedName("GoldCarvingTool");
        this.setCreativeTab(CreativeTabsLoader.tabStairsRevolution);
        this.setTextureName(StairsRevolution.MODID + ":carvingtool_gold");
    }
}
