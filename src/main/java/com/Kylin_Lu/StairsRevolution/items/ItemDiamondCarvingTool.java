...
public class ItemDiamondCarvingTool extends Item {
    public ItemDiamondCarvingTool(){
        super();
        this.setUnlocalizedName("DiamondCarvingTool");
        this.setCreativeTab(CreativeTabsLoader.tabStairsRevolution);
        this.setTextureName(StairsRevolution.MODID + ":carvingtool_diamond");
    }
}
