...
public class ItemIronCarvingTool extends Item{
    public ItemIronCarvingTool(){
        super();
        this.setUnlocalizedName("IronCarvingTool");
        this.setCreativeTab(CreativeTabsLoader.tabStairsRevolution);
        this.setTextureName(StairsRevolution.MODID + ":carvingtool_iron");
    }
}
